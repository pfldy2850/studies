...
class _CustomVideoPlayerState extends State<CustomVideoPlayer> {
  ...
  onReversePressed() {
    final currentPoisition = videoController!.value.position;

    Duration position = Duration();

    if (currentPoisition.inSeconds > 3) {
      position = currentPoisition - Duration(seconds: 3);
    }
